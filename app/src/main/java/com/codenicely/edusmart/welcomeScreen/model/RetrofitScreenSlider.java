package com.codenicely.edusmart.welcomeScreen.model;
...
import com.codenicely.edusmart.welcomeScreen.api.RequestScreen;
...
public class RetrofitScreenSlider  implements ScreenSliderHelper{
    ...
    public void getSlides(final SlidesRequestCallback slidesRequest) {
            ...
            Call<WelcomeData> call= requestScreen.getJSON();
